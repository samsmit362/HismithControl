...
void run_funscript()
{
	...
	while (!g_stop_run && get_next_frame_and_cur_speed_res)
	{
		...
		if (capture.isOpened())
		{
			...
			__int64 action_start_time, speed_change_time, prev_get_speed_time = start_time;
