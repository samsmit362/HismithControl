...
extern bool g_show_message_box_with_error;
extern bool g_blnNoGUI;

#define SaveToReportLog(...) SaveToReportLog(__FILE__, __LINE__, LOG_FUNC_NAME, __VA_ARGS__)
#define SaveError(msg) SaveError(__FILE__, __LINE__, LOG_FUNC_NAME, msg)
