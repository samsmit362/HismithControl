...
std::map<int, InputDevice> DeviceEnumerator::getVideoDevicesMap() {
	return getDevicesMap(CLSID_VideoInputDeviceCategory);
}

std::map<int, InputDevice> DeviceEnumerator::getAudioDevicesMap() {
	return getDevicesMap(CLSID_AudioInputDeviceCategory);
}

// Returns a map of id and devices that can be used
std::map<int, InputDevice> DeviceEnumerator::getDevicesMap(const GUID deviceClass)
{
	std::map<int, InputDevice> deviceMap;
